...
spawn(
    function()
        ...
        WeaponTab = Window:NewTab({Title = "Item", Icon = getRandomIcon()}) 
        ...
        do
            DefaultTab:AddSection("toi nho emmm")
            SeaBeastTab:NewButton({
                Title = "Fly Boat",
                Callback = function()
            ...
            if V4Tab then 
                ...
                V4Tab:AddSection("Pull Lever")
                V4Tab:NewToggle("Auto Pull Lever",{
                    Title = "Auto Pull Lever",
                    Description = "Will Automatic Do Pull Lever (required requirements)."
                })
                V4Tab:NewButton({
            ...
            if WeaponTab then 
                ...
                elseif Sea1 then 
                    WeaponTab:AddSection("Don't Support")
                end 
                if Sea3 then 
