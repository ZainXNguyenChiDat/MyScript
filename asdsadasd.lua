...
DropdownSelectMode:SetValue("Melee")
DropdownSelectMode:OnChanged(
    function(Value)
    ...
    spawn(function()
        while wait() do
            if _G.Auto_Farm_Level then
                ...
                elseif _G.Select_Mode_Farm == "Bone" then
    ...
    spawn(
        function()
            while wait() do
                ...
                elseif _G.Select_Mode_Farm == "Cake Prince" then
                   spawn(
        function()
            while wait() do
                    pcall(
