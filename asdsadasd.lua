...
do
    ...
    DropdownDelayAttack:SetValue("0.17")
                                     ...
                                     then
                                        if v.Name == Ms then
                                            repeat
                                                ...
                                                MonFarm = v.Name
                                            until --Click
                                            not TypeModeFarm1 or TypeFarm or not v.Parent or v.Humanoid.Health <= 0 or
                                                    ...
                                                    if
                                                     ...
                                                     then
                                                        repeat
                                                            ...
                                                            FarmPos = v.HumanoidRootPart.CFrame
                                                            MonFarm = v.Name
                                                        until not TypeModeFarm1 or TypeFarm or v.Humanoid.Health <= 0 or not v.Parent or
                                                            game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible ==
                                                                false
                                                    else
                                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
