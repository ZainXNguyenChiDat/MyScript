...
local Window =
    Fluent:CreateWindow(
    {
        Title = "Sadnessdontsuy [ NguyenChiDat ]",
        SubTitle = "zzz",
        TabWidth = 160,
...
local Tabs = {
    ...
    Stats = Window:AddTab({Title = "Stats", Icon = "signal-high"}),
    Player = Window:AddTab({Title = "Local Player", Icon = "code-2"}),
    Teleport = Window:AddTab({Title = "Travel", Icon = "map-pin"}),
    Fruit = Window:AddTab({Title = "Fruit", Icon = "activity"}),
    Raid = Window:AddTab({Title = "Raid", Icon = "heart"}),
...
do
	...
	if _G.FastAttackFaiFao_Mode == "0.25" then
		_G.Fast_Delay = 0.25
	elseif _G.FastAttackFaiFao_Mode == "0.17" then
		_G.Fast_Delay = 0.17
    ...
    local ListModeFarm = {"Level", "Bone", "Cake Prince"}

    local DropdownModeFarm =
        Tabs.Main:AddDropdown(
        "DropdownDelayAttack",
        {
    ...
    DropdownModeFarm:SetValue("Level")
    DropdownModeFarm:OnChanged(function(Value)
    _G.ModeFarm_Mode1 = Value
	if _G.ModeFarm_Mode1 == "Level" then
		_G.AutoLevel = Value
	elseif _G.ModeFarm_Mode1 == "Bone" then
		_G.AutoBone = Value
	elseif _G.ModeFarm_Mode1 == "Cake Prince" then
		_G.CakePrince = = Value
	end
end)

    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Start Farm", Default = false})
    ...
    if Third_Sea then
        local RoughSea = Tabs.Main:AddSection("Kitsune Function")
...
local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Enable Bypass Teleport", Default = false})
...
local ToggleV3 = Tabs.Setting:AddToggle("ToggleV3", {Title = " Enable Auto Active V3", Default = false})
ToggleV3:OnChanged(
    function(Value)
        _G.ActiveRaceV3 = Value
    end
)
...
local ToggleBuso = Tabs.Setting:AddToggle("ToggleBuso", {Title = " Enable Auto Buso", Default = false})
ToggleBuso:OnChanged(
    function(Value)
        _G.AutoBuso = Value
    end
)
Options.ToggleBuso:SetValue(false)
...
local Mastery = Tabs.Player:AddSection("Esp")

local ToggleEspPlayer = Tabs.Player:AddToggle("ToggleEspPlayer", {Title = "ESP Player", Default = false})
...
local ToggleEspFruit = Tabs.Player:AddToggle("ToggleEspFruit", {Title = "ESP Devil Fruit", Default = false})
...
local ToggleEspIsland = Tabs.Player:AddToggle("ToggleEspIsland", {Title = "ESP Island", Default = false})
...
local ToggleEspFlower = Tabs.Player:AddToggle("ToggleEspFlower", {Title = "ESP Flower", Default = false})
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Auto Complete Trial", Default = false})
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "Auto Train Acient Quest", Default = false})
...
local Mastery = Tabs.Misc:AddSection("Kaitun Cap Picture")
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Misc:AddSection("Thid Sea For Hop.")
end

if Third_Sea then
    local ToggleFindMoon = Tabs.Misc:AddToggle("ToggleFindMoon", {Title = "Find Full Moon", Default = false})
    ...
    local ToggleMirageIsland = Tabs.Misc:AddToggle("ToggleMirageIsland", {Title = "Find Mirage Island", Default = false})
