    ...
    if sign_match == decode_response.sign then
        ...
        function TPServer(JobIdorstring)
            if string.find(JobIdorstring, "TeleportService") then
                ...
                if deptrai then
                    return "Sucessfullys | Teleporting..."
                else
                    return tao
                end
            else
        ...
        function CheckIsRaiding()
            ...
            if not ALLCHECK_Func["Auto Trial"]() and game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible and not GetSeaBeastTrial() and GetDistance(CFrame.new(28282.5703125, 14896.8505859375, 105.1042709350586)) > 3000 then
                return true
            end
        end
            ...
            ["Auto Trial"] = function() 
                ...
                if GetDistance(CyborgBypassCFrame) < 2000 then 
                    repeat 
                        ...
                        task.wait(1)
                    until not Config["Auto Trial"] or GetDistance(CyborgBypassCFrame) > 2000
                elseif TheMazePoint and GetDistance(TheMazePoint) < 2000 then 
                    repeat 
                        ...
                        task.wait(1)
                    until not Config["Auto Trial"] or GetDistance(TheMazePoint) > 2000 
                elseif FinishPart and GetDistance(FinishPart) < 2000 then  
                    repeat 
                        ...
                        task.wait(1)
                    until not Config["Auto Trial"] or GetDistance(FinishPart) > 2000 
                elseif GetSeaBeastTrial() and GetDistance(GetSeaBeastTrial().HumanoidRootPart) < 2000 and GetDistance(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Trial of Water")) < 1500 then   
                    ...
                    until not Config["Auto Trial"] or GetDistance(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Trial of Water")) > 1500 or not GetSeaBeastTrial()  or GetDistance(GetSeaBeastTrial().HumanoidRootPart) > 2000
                ...
                elseif StrengthPart and GetDistance(StrengthPart) < 2000 then 
                    ...
                    until not Config["Auto Trial"] or GetDistance(StrengthPart) > 2000
                elseif GetDistance(GhoulhPart) < 2000 then 
                    OldCFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame  
                    repeat task.wait()
                    ...
                    until not Config["Auto Trial"] or GetDistance(GhoulhPart) > 2000
                end
            end,
            ["Auto Mirage Puzzle"] = function()
                if not Sea3 then return end 
        ...
        do
            ...
            FarmTab:AddSection("Elite | Rip India | Dough King | Functions")
            ...
            if V4Tab then 
                ...
                TrialStage1_Toggle = V4Tab:NewToggle("Auto Trial",{
                    Title = "Auto Trial",
                    Description = "Auto Trial All Race."
                })
