...
local ToggleActiveV4 = Tabs.Setting:AddToggle("ToggleActiveV4", {Title = " Enable Auto Active V4", Default = true})
ToggleRemove:OnChanged(
    function(Value)
...
local ToggleBuso = Tabs.Setting:AddToggle("ToggleAutobuso", {Title = " Enable Auto Buso", Default = false})
ToggleRemove:OnChanged(
    function(Value)
        _G.AutoBuso = Value
    end
...
local ToggleBuso = Tabs.Setting:AddToggle("ToggleActiveV3", {Title = " Enable Auto Active V3", Default = false})
ToggleRemove:OnChanged(
    function(Value)
