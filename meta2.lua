...
local ToggleRemove1 = Tabs.Setting:AddToggle("ToggleRemove", {Title = " Enable Auto Active V4", Default = false})
ToggleRemove1:OnChanged(
    function(Value)
        _G.ActiveRaceV4 = Value
    end
)
Options.ToggleRemove1:SetValue(false)

spawn(
    function()
        while wait() do
            if _G.ActiveRaceV4 then
                if  game.Players.LocalPlayer.Character:FindFirstChild("RaceEnergy") and
...
local ToggleRemove2 = Tabs.Setting:AddToggle("ToggleBuso", {Title = " Enable Auto Buso", Default = false})
ToggleRemove2:OnChanged(
    function(Value)
        _G.AutoBuso = Value
    end
)
Options.ToggleRemove2:SetValue(false)
