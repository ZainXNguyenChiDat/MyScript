...
local ToggleRemove1 = Tabs.Setting:AddToggle("ToggleRemove", {Title = " Enable Auto Active V4", Default = true})
ToggleRemove:OnChanged(
    function(Value)
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = " Enable Auto Buso", Default = true})
ToggleRemove:OnChanged(
    function(Value)
        _G.AutoBuso = Value
    end
